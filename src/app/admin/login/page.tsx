  ...
  return (
    <div className="mx-auto flex min-h-[70vh] max-w-md flex-col justify-center px-4 py-16">
      <div className="rounded-card border border-line bg-surface-raised p-8 shadow-card">
        ...
        <p className="mt-1 text-sm text-muted">Restricted area for supplier and site management.</p>
        ...
        <form onSubmit={submit} className="mt-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="mt-1.5 w-full rounded-chip border border-line bg-surface px-3.5 py-2.5 text-sm text-content outline-none"
            />
          </div>
          <div>
